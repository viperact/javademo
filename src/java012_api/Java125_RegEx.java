...
public class Java125_RegEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(sn.matches(".*[^0-9].*")); // ^ : not을 뜻함(부정)
		System.out.println(sn.matches(".*[\\D].*")); // \\D : not을 의미함
		 ...
		 * find() : 최초의 패턴위치로 이동한 뒤 True 반환, 없으면 false 
		 * find(int start) : start 위치 부터 find 
		 * start() : 매칭되는패턴의 시작 인덱스 반환 
		 ...
		 * groupCount() : 패턴내 그룹핑(괄호로 묶은패턴들)의 갯수 반환 
        ...
        */
		...
		Pattern pt = Pattern.compile("best", Pattern.CASE_INSENSITIVE);//대소문자 상관없이
